                ...
                <div className="h-64 relative">
                    ...
                    {isValidData ? (
                        <ChartContainer config={chartConfig}>
                            <ScatterChart data={data} margin={{ top: 20, right: 20, bottom: 20, left: 20 }} height={256}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis type="number" dataKey="x" name="Risk" axisLine={false} tickLine={false} domain={['dataMin', 'dataMax']} />
                                <YAxis type="number" dataKey="y" name="Return" axisLine={false} tickLine={false} domain={['dataMin', 'dataMax']} />
                                <ZAxis type="number" dataKey="z" range={[50, 500]} name="Volume" />
                                ...
                                <Scatter name="Trades" data={data} fill="var(--color-x)" />
                            </ScatterChart>
                        </ChartContainer>
                    ) : (
